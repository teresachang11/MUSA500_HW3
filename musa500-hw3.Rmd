...
```{r}
variables <- c("FATAL_OR_M", "OVERTURNED", "CELL_PHONE", "SPEEDING", "AGGRESSIVE", "DRIVER1617", "DRIVER65PLUS")
tab_xtab(var.row = crash_data$FATAL_OR_M, var.col = crash_data$DRINKING_D, show.row.prc = TRUE)
tab_xtab(var.row = crash_data$FOVERTURNED, var.col = crash_data$DRINKING_D, show.row.prc = TRUE)
for (var in variables) {
  tab_xtab(var.row = crash_data[[var]], var.col = crash_data$DRINKING_D, show.row.prc = TRUE)
